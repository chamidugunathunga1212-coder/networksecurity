...
class DataValidation:
    ...
    def __init__(self,data_ingestion_artifact:DataIngestionArtifact,data_validation_config:DataVAlidationConfig):
        try:
            ...
            self._schema_congig = read_yaml_file(SCHEMA_FILE_PATH) 
    ...
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            number_of_columns = len(self._schema_congig)
    ...
    def initiate_data_validation(self)-> DataValidationArtifact:
        try:
            ...
            train_file_path = self.data_ingestion_artifact.trained_file
            ...
            data_validation_artifacts = DataValidationArtifact(
                ...
                valid_train_file_path=self.data_ingestion_artifact.trained_file,
                valid_test_file_path=self.data_ingestion_artifact.test_file,
