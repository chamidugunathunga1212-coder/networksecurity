...
class DataIngestion:
    ...
    def export_data_into_feature_store(self,datafrome:pd.DataFrame):
        try:
            ...
            datafrome.to_csv(feature_store_file_path,index=False,header=True)
            return datafrome
    ...
    def split_data_as_train_test(self,dataframe: pd.DataFrame):
        try:
            ...
            logging.info("Expoted train and train file path")
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            dataframe = self.export_data_into_feature_store(datafrome=dataframe)
            self.split_data_as_train_test(dataframe=dataframe)
            dataingestionartifact = DataIngestionArtifact(
                trained_file=self.data_ingestion_config.training_file_path,
